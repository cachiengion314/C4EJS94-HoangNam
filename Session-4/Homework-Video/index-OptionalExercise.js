...
console.log(`Object-Optional(2)`);
console.log(`movie count: ${movieObject.results.length}`);
console.table(movieObject.results[0]);
///
console.log(`Data of the first movie \n
title: ${movieObject.results[0].title} \n
vote_average: ${movieObject.results[0].vote_average} \n
genres: ${movieObject.results[0].genres}
`);
/// log out all movie
for (let i = 0; i < movieObject.results.length; i++) {
    console.log(`Data of movie ${i + 1}  \n
    title: ${movieObject.results[i].title} \n
    vote_average: ${movieObject.results[i].vote_average} \n
    genres: ${movieObject.results[i].genres}
    `);
}
