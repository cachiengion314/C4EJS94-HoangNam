...
for (let i = 0; i < jobData.hits.length; i++) {
    ...
    for (let ii = 0; ii < jobData.hits[i].locations.length; ii++) {
        console.log(`- ${jobData.hits[i].locations[ii]}`)
    }
    console.log(`skills value:`);
    for (let ii = 0; ii < jobData.hits[i].skills.length; ii++) {
        console.log(`- ${jobData.hits[i].skills[ii]}`);
    }
    console.log(`jobSalary value:`);
