...
${data.hits[0].jobTitle}`);
/// 5
let benefits = data.hits[0].benefits;
console.log(`Benefits of the first job hit`);
console.log(benefits);
/// 6
let benefitArr = [];
for (let i = 0; i < data.hits[0].benefits.length; i++) {
    benefitArr.push(data.hits[0].benefits[i]);
}
...
for (let i = 0; i < data.hits.length; i++) {
    ...
    for (let item of data.hits[i].benefits) {
        console.log(item);
    }
}
/// 8
...
for (let i = 0; i < data.hits.length; i++) {
    ...
    for (let ii = 0; ii < data.hits[i].locations.length; ii++) {
        console.log(data.hits[i].locations[ii]);
    }
    console.log(`Skills: `);
    for (let ii = 0; ii < data.hits[i].skills.length; ii++) {
        console.log(data.hits[i].skills[ii]);
    }
