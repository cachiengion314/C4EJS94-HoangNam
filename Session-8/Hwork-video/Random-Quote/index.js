...
function showRandomQuote() {
    ...
    quoteTag.textContent = quoteData[randomIndex].quoteText;
    authorTag.textContent = quoteData[randomIndex].quoteAuthor;
    if (authorTag.textContent == "") {
        authorTag.textContent = `Unknow`;
    }
}
showRandomQuote();

function reloadClickFunc() {
    reloadClickCallback();
}

function reloadClickCallback() {
    showRandomQuote();
}
reloadBtn.addEventListener(`click`, reloadClickCallback);